                        ...
                        <div className="f-col-one flex flex-col">
                            ...
                            <div className="f-col-four">
                                ...
                                <form action="" className='newletter-form'>
                                    ...
                                    <button className='main-btn flex' aria-label="Subscribe to Newsletter"><span className='btn-icon bg-black centered-block'><svg className="b-arrw" width="13" height="12" viewBox="0 0 13 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    </svg></span><span className='text-md text-grey text-16'></span></button>
                                </form>
                            </div>
