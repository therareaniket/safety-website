                ...
                <div className="plans-row flex">
                    ...
                    >
                        ...
                        <div className="plan-btn">
                            <Link href="/ComingSoon" title="coming soon" className='main-btn flex'><span className='btn-icon bg-white centered-block'><svg className="b-arrw" width="13" height="12" viewBox="0 0 13 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    >
                        ...
                        <div className="plan-btn">
                            <Link href="/ComingSoon" title="coming soon" className='main-btn flex'><span className='btn-icon bg-black centered-block'><svg className="b-arrw" width="13" height="12" viewBox="0 0 13 12" fill="none" xmlns="http://www.w3.org/2000/svg">
