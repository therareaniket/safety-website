            ...
            <section className="section legel-page">
                <div className="container">
                    ...
                    <div className="text-block">
                        <h2 className="h4 text-md">1. Acceptance & Eligibility</h2>
                    ...
                    <div className="text-block">
                        <h2 className="h4 text-md">2. Account & Access</h2>
                    ...
                    <div className="text-block">
                        <h2 className="h4 text-md">3. License & Customer Data</h2>
                    ...
                    <div className="text-block">
                        <h2 className="h4 text-md">4. Acceptable Use</h2>
                    ...
                    <div className="text-block">
                        <h2 className="h4 text-md">5. Compliance Responsibilities</h2>
                    ...
                    <div className="text-block">
                        <h2 className="h4 text-md">6. Third‑Party Services</h2>
                    ...
                    <div className="text-block">
                        <h2 className="h4 text-md">7. Confidentiality</h2>
                    ...
                    <div className="text-block">
                        <h2 className="h4 text-md">8. Fees, Taxes & Orders (if applicable)</h2>
                    ...
                    <div className="text-block">
                        <h2 className="h4 text-md">9. Miscellaneous</h2>
