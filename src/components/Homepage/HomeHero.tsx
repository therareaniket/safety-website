                                ...
                                <Link href='/ComingSoon' title="Book a demo">
                                    <div className="book-demo-inner flex">
                                        <span className="flex">
                                            ...
                                            </svg></span><span className="book-btn-icon bg-white centered-block"><Image className="" src='/images/homepage/star.svg' alt="star"  width={50} height={50} fetchPriority="high" priority /></span>
                                        </span>
                                        <div className=""><p className="text-18 text-sb text-purple">Explore Products</p></div>
                                    </div>
                                </Link>
                            </div>
                        </div>
