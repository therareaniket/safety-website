                    ...
                    <div className="hero-row flex items-center">
                        <div className="hero-col-one">
                            ...
                            <div className="book-demo-inner flex">
                                <span className="flex">
                                    <span className="book-btn-icon bg-purple centered-block"><svg width="21" height="19" viewBox="0 0 21 19" fill="none" xmlns="http://www.w3.org/2000/svg">
...
</svg></span><span className="book-btn-icon bg-white centered-block"><Image className="" src={Star} alt="star" width={50} height={50} priority /></span>
                                </span>
