                ...
                <div className="plans-row flex">
                    <div className="plan-item plan-home-page standard">
                        ...
                        <div className="plan-btn">
                            <Link href="/Contact#contact-form" className='main-btn flex'><span className='btn-icon bg-white centered-block'><svg className="b-arrw" width="13" height="12" viewBox="0 0 13 12" fill="none" xmlns="http://www.w3.org/2000/svg">
