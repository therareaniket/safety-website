                ...
                <div className="plans-row flex">
                    <div className="plan-item plan-home-page standard">
                        <div className="plan-title flex">
                            ...
                            <h3 className="h4 text-sb text-white">{homePricingCards.standardTitle}</h3>

                            <div className="p-price flex"><h4 className="text-bd text-white">{homePricingCards.standardPrice}</h4><span className="text-18 text-white">{homePricingCards.standardPricePerMonth}</span></div>
                        </div>
                    ...
                    <div className="plan-item plan-home-page enterprise">
                        <div className="plan-title flex">
                            <h3 className="h4 text-sb text-white">{homePricingCards.enterpriseTitle}</h3>
                            <div className="p-price flex"><h4 className="text-bd text-white">{homePricingCards.enterprisePrice}</h4><span className="text-18 text-white">{homePricingCards.enterprisePricePerMonth}</span></div>
                        </div>
